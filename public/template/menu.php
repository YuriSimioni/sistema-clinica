...
<body>
    <aside id="menu">
        <a href="dashboard.php" class="title"><?php echo strtoupper($Projeto->getNome())?></a>

        <a href="" class="button-menu newMail">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M176-183q-20 8-38-3.5T120-220v-180l320-80-320-80v-180q0-22 18-33.5t38-3.5l616 260q25 11 25 37t-25 37L176-183Z"/></svg>
            New Mail
        </a>
        ...
        <?php
            ...
            if(isset($_SESSION['logged'])) {
                if($_SESSION['user']['access_level'] == "Admin" or $_SESSION['user']['access_level'] == "Moderator") {
                    ?>
                    <a href="" class="button-menu staff">
